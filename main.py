...
async def data_entry(request: DataEntryRequest, db: Session = Depends(get_db)):
    ...
    # (আপনার আগের সব কোডের একদম নিচে এইটুকু যোগ করবেন)

# ==========================================
# THE CLOUD FRONTEND SERVER
# ==========================================
...
async def serve_dashboard():
    try:
        ...
        return HTMLResponse(content="<h1>Agency OS is updating. Dashboard coming soon.</h1>", status_code=404)
